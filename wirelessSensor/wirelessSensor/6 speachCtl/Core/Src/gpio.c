...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_RED_Pin|LED_YEL_Pin|RELAY_Pin|SMOKE_EN_Pin
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = LED_RED_Pin|LED_YEL_Pin|LED_GRE_Pin|RELAY_Pin
                          |SMOKE_EN_Pin|WIFI_EN_Pin;
